...
<?php 
    ...
    function Description() {
        return (
            "
                \nCiao! Benvenuto nel gioco dell'oroscopo!\nIn questo gioco potrai scoprire le tue sorti inserendo il tuo segno zodiacale e il giorno corrente (compreso tra 1 e 31).\n
                \n*A causa di una versione troppo recente di PHP, non è stato possibile implementare i thread (versione utilizzata: 'vs16'. Ultima versione supportata: 'vc14'). 
            \n"
        );
    }
?>
